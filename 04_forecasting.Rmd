...
## ETS + SARIMA + NNAR
```{r Combination}
source("~/Documents/GitHub/RIDB/combProcess.R")
...
ggplot(pred_melt_rpart, aes(Var2, value, group = Var1)) +
  ...
  labs(x = "Time", y = "Occupnacy (%)", title = "Bagging with RPART") + 
    ...
    scale_x_continuous(breaks = c(1,2,3,4,5,6),labels=as.character(c("March 2017","April 2017","May 2017","June 2017","July 2017","August 2017"))) +

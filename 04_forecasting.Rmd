...
source("~/Github/RIDB/grid_arrange_shared_legend.R")
jpeg(filename = "forecasting12.jpeg", width = 20, height = 10, units = 'in', res = 300)
...
source("~/Github/RIDB/grid_arrange_shared_legend.R")
jpeg(filename = "forecasting6.jpeg", width = 20, height = 10, units = 'in', res = 300)
grid_arrange_shared_legend(a, b, c, d, e, ncol=3, nrow=2)
dev.off()  
```
